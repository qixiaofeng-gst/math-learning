...
\begin{longtable}
%{p{3cm}p{5.5cm}HH} % Show root and meanings.
{p{2cm}p{2cm}Hp{4.5cm}} % Show root, meanings and examples.
%{p{6.5cm}Hp{2cm}H} % Show root and origin.
%{HHHp{8.5cm}} % Only show example.
